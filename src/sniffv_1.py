    ...
    if eth_protocol == 8 :
 	...
 	fo.write(eth_packet_data)
        ...
        if protocol == 6 :
            ...
            tcp_data='Source Port : ' + str(source_port) + ' Dest Port : ' + str(dest_port) + ' Sequence Number : ' + str(sequence) + ' Acknowledgement : ' + str(acknowledgement) + ' TCP header length : ' + str(tcph_length)+"\n"
            print tcp_data
            fo.write(tcp_data)
        ...
        #ICMP Packets
            ...
            code = icmph[1]
            checksum = icmph[2]
            icmp_data='Type : ' + str(icmp_type) + ' Code : ' + str(code) + ' Checksum : ' + str(checksum)+"\n"
            print icmp_data
            fo.write(icmp_data)
        ...
        #UDP packets
            ...
            length = udph[2]
            checksum = udph[3]
            udp_data='Source Port : ' + str(source_port) + ' Dest Port : ' + str(dest_port) + ' Length : ' + str(length) + ' Checksum : ' + str(checksum)+"\n" 
            print udp_data
            fo.write(udp_data) 
